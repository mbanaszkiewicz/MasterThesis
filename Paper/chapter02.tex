...
\item \emph{Reduce} aggregates the results from \empg{Map} by applying a function to values with the same key, with goal of reducing the amount of data. From there more functions can be composed into the chain.
\end{itemize}
