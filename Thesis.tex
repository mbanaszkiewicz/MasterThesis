...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
<<<<<<< HEAD
\title{ Zastosowanie technik programowania wspÛ≥bieønego do optymalizacji algorytmÛw i oprogramowania na platformie .NET}
\titleShort{Application of concurrent programming
techniques ...}
=======
\title{Zastosowanie technik programowania wspÛ≥bieønego do optymalizacji algorytmÛw i oprogramowania na platformie .NET}
